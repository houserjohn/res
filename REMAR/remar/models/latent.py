...
from remar.common.util import get_z_stats
from remar.common.classifier import Classifier
from remar.common.latent import DependentLatentModel
from remar.utils import get_args
...
class LatentRationaleModel(nn.Module):
    ...
    def __init__(self,
        ...
        #Using dependent at the moment
        self.dependent_z = True
    ...
    def forward(self, x):
        ...
        #return rationale at the moment
        return z
